...
public class BurnableLog : MonoBehaviour {
    ...
    void Start()
    {
        ...
        {
            originalmeshcolor = MyMeshRenderer.material.color;
    ...
    public void Kill()
    {
        ...
        foreach (Rigidbody2D r in DependentRigidbodies)
        {
            if (r == null) continue;
    ...
    public Rigidbody2D[] DependentRigidbodies;
    public void TakeDamage(float dmg, Vector2 dir)
    {
        ...
        if (MyMeshRenderer != null)
        {
            MyMeshRenderer.material.color = Color.Lerp(Color.black,originalmeshcolor,hp/MaxHealth);
